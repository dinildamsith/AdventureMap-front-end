...
function NavBar() {
    ...
    return (
        <>
            <div className="fixed top-0 left-0 w-full max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 z-[999] bg-transparent text-white text-base font-inter font-medium">
                ...
                >
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                        <li>
                            <a href="#" className="block py-2 px-3 text-white hover:text-gray-200">
                                Guides
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#dd" className="block py-2 px-3 text-white hover:text-gray-200">
                                Hotels
                            </a>
                        </li>
                    </ul>
            ...
            <div className="pt-[75px]">{/* Main content goes here */}</div>
        </>
    );
}
