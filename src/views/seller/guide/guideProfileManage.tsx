...
import {
  ...
  postRequest,
  putRequest,
} from "../../../services/httpServices.js";
// @ts-ignore
import {
  BASE_URL,
  GUIDE_GALLERY_UPDATE_URL,
  GUIDE_RENT_PENDING_ORDERS_GET_URL,
  GUIDE_UPDATE_URL,
  IMAGE_UPLOAD_URL,
        ...
        <div className={"mt-28"}>
              ...
              <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                ...
                <div className="col-span-4 sm:col-span-3">
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <ul>
                        {updatedData.languages.map(
                          (languages: any, index: any) => (
                ...
                <div className="col-span-4 sm:col-span-9">
                  ...
                  >
                    ...
                    {activeTab === "about" && (
                      <>
                        <p className="text-gray-700">{updatedData.about}</p>
                      </>
                    )}
                    ...
                    {activeTab === "orders" && (
                      <>
                        <div
                          className={
                            "flex flex-wrap justify-center rounded-2xl"
                          }
                          style={{
                            position: "absolute",
                        ...
                        >
                          {pendingOrder && pendingOrder.length > 0 ? (
                            pendingOrder.map((order: any) => (
                              <OrderNotify key={order.id} order={order} />
                            ))
                          ) : (
                            <>
          ...
          {isEditModalOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div
                className="bg-white rounded-lg p-6 w-96 mt-[5rem]"
